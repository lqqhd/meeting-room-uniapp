<template>
  ...
  <view class="container">
    <view class="grid">
      ...
      <picker id="deptId" @change="bindSelectChange" :value="dict.deptIdIndex" range-key="name" :range="dict.deptIdArray">
        <i-input id="dept" :value="dict.deptIdArray[dict.deptIdIndex]['name']" title="所属部门" placeholder="请选择所属部门" disabled2 right rightIcon="enter" rightIconSize="18" :errorMessage="errMsgs.deptErrMsg"></i-input>
      </picker>
      <i-input id="name" :value="entry.name" title="姓名" placeholder="请填写姓名" maxlength="50" @change="bindChange" right :errorMessage="errMsgs.nameErrMsg"></i-input>
      <i-input id="mobile" :value="entry.mobile" title="手机号" placeholder="请填写手机号" maxlength="20" @change="bindChange" right :errorMessage="errMsgs.mobileErrMsg"></i-input>
    ...
    <i-input id="password" :value="entry.password" title="密码" :placeholder="passwordHint" maxlength="200" @change="bindChange" right :errorMessage="errMsgs.passwordErrMsg"></i-input>
    <i-input id="sort" :value="entry.sort" type="number" title="序号" placeholder="请填写序号" maxlength="20" @change="bindChange" right :errorMessage="errMsgs.sortErrMsg"></i-input>
    <view class="btn-box">
