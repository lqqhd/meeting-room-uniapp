<template>
  ...
  <view class="container"> 
	...
	<i-input id="name" :value="entry.name" title="会议室名称" placeholder="请填写会议室名称" maxlength="64" @change="bindChange" right :errorMessage="errMsgs.nameErrMsg"></i-input>
	<i-input id="xh" :value="entry.xh" type="number" title="顺序号" placeholder="请填写顺序号" maxlength="3" @change="bindChange" right :errorMessage="errMsgs.xhErrMsg"></i-input>
	<i-cell title="是否激活">
		<i-switch id="isActive" :value="entry.isActive" @change="bindSwitchChange" slot="footer"></i-switch>
	</i-cell>
	<i-cell title="是否需要审核">
		<i-switch id="isNeedAudit" :value="entry.isNeedAudit" @change="bindSwitchChange" slot="footer"></i-switch>
	</i-cell>
</view>
    <view class="btn-box">
