  ...
  <view class="container">
    <view class="grid">
      ...
      <view :style="'display:' + (useWx?'none':'block')">
        <i-input id="name" :value="entry.name" title="姓名" placeholder="填写姓名，便于与同事沟通" maxlength="50" @change="bindChange" :errorMessage="errMsgs.nameErrMsg"></i-input>
        <i-input id="mobile" :value="entry.mobile" title="手机号" placeholder="请填写手机号" maxlength="20" @change="bindChange" :errorMessage="errMsgs.mobileErrMsg"></i-input>
