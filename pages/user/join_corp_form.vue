<template>
  ...
  <view class="container">
    ...
    <i-radio-group :current="current" @change="handleClick">
      ...
      <i-input id="code" :value="entry.code" title placeholder="请填写邀请码" maxlength="50" @change="bindChange" :errorMessage="errMsgs.codeErrMsg"></i-input>
      <i-radio value="方式二、通过组织名称加入（需管理员审核）"> </i-radio>
      <i-input id="name" :value="entry.name" title placeholder="请填写组织名称" maxlength="20" @change="bindChange" :errorMessage="errMsgs.nameErrMsg"></i-input>
    </i-radio-group>
    <view class="btn-box">
