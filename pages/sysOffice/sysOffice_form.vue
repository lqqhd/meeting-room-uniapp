<template>
  ...
  <view class="container">
    <view class="grid">
      ...
      <i-input id="name" :value="entry.name" title="名称" placeholder="请填写名称" maxlength="100" @change="bindChange" right :errorMessage="errMsgs.nameErrMsg"></i-input>
      <i-input id="inviteCode" :value="entry.inviteCode" title="部门邀请码" placeholder="自动生成，无需填写" maxlength="20" @change="bindChange" disabled right :errorMessage="errMsgs.inviteCodeErrMsg"></i-input>
      <i-input id="sort" :value="entry.sort" type="number" title="排序" placeholder="不填写，则默认递增" maxlength="0" @change="bindChange" right :errorMessage="errMsgs.sortErrMsg"></i-input>
      <i-input id="phone" :value="entry.phone" title="电话" placeholder="请填写电话" maxlength="200" @change="bindChange" right :errorMessage="errMsgs.phoneErrMsg"></i-input>
      <i-cell title="是否启用">
        <i-switch id="useable" :value="entry.useable" @change="bindSwitchChange" slot="footer"></i-switch>
      </i-cell>
     </view>
    <view class="btn-box">
